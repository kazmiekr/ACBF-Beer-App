...
Ext.define('ACBF.view.RatingControl', {
	 ...
	 * @param {ACBF.view.RatingControl} this This field
	...
	initialize: function () {
		...
		var me = this;
		ACBF.view.RatingControl.superclass.initialize.apply(me, arguments);
